      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Onboard-ForgotPassword',
              path: 'forgot-password',
              builder: (context, params) => OnboardForgotPasswordWidget(),
            ),
            FFRoute(
              name: 'Home',
              path: 'home',
            ...
            FFRoute(
              name: 'Onboard-Phone',
              path: 'phone-login',
              builder: (context, params) => OnboardPhoneWidget(),
            ),
            FFRoute(
              name: 'Onboard-PhoneVerification',
              path: 'phone-verification',
              builder: (context, params) => OnboardPhoneVerificationWidget(
            ...
            FFRoute(
              name: 'Onboard-ChangePassword',
              path: 'change-password',
              builder: (context, params) => OnboardChangePasswordWidget(),
            ),
            FFRoute(
              name: 'CourseCategory',
            ...
            FFRoute(
              ...
              builder: (context, params) => UniversityFORMWidget(
                countryRef: params.getParam(
                  'countryRef',
                  ParamType.Document,
                ),
                universityRef: params.getParam(
                  'universityRef',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              ...
              builder: (context, params) => CourseCategoryFORMWidget(
                courseCategoryRef: params.getParam(
                  'courseCategoryRef',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              ...
              builder: (context, params) => UniversityWidget(
                countryRef: params.getParam(
                  'countryRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              ...
              path: 'country-form',
              requireAuth: true,
              builder: (context, params) => CountryFORMWidget(
                countryRef: params.getParam(
                  'countryRef',
            ...
            FFRoute(
              ...
              builder: (context, params) => BranchFORMWidget(
                countryRef: params.getParam(
                  'countryRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              ...
              builder: (context, params) => BranchWidget(
                countryRef: params.getParam(
                  'countryRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: 'Meeting-BookingList',
              path: 'Booking',
              requireAuth: true,
              asyncParams: {
                'meetingRef': getDoc(['meeting'], MeetingRecord.fromSnapshot),
              },
              builder: (context, params) => MeetingBookingListWidget(
            ...
            FFRoute(
              ...
              builder: (context, params) => MeetingListWidget(
                courseRef: params.getParam(
                  'courseRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              ...
              builder: (context, params) => MeetingEditorWidget(
                meetingRef: params.getParam(
                  'meetingRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: 'Batch-CourseList',
              path: 'batch-courselist',
              requireAuth: true,
              asyncParams: {
                'batchRef': getDoc(['batches'], BatchesRecord.fromSnapshot),
              },
              builder: (context, params) => BatchCourseListWidget(
                batchRef: params.getParam(
                  'batchRef',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              ...
              builder: (context, params) => BatchEditorWidget(
                batchRef: params.getParam(
                  'batchRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: 'Batch-ChangeBatchStatus-Course',
              path: 'batchStatusChangesProcess',
              requireAuth: true,
              asyncParams: {
                'batchesRef': getDoc(['batches'], BatchesRecord.fromSnapshot),
              },
              builder: (context, params) => BatchChangeBatchStatusCourseWidget(
                batchesRef: params.getParam(
                  'batchesRef',
                  ParamType.Document,
                ),
                batchesStatus: params.getParam(
                  'batchesStatus',
                  ParamType.String,
                ),
              ),
            ...
            FFRoute(
              name: 'Batch-ChangeBatch-SingleCourse',
              path: 'batch-change-in-course',
              requireAuth: true,
              asyncParams: {
                'courseRef': getDoc(['course'], CourseRecord.fromSnapshot),
              },
              builder: (context, params) => BatchChangeBatchSingleCourseWidget(
                courseRef: params.getParam(
                  'courseRef',
                  ParamType.Document,
                ),
                prevBatchesRef: params.getParam(
                  'prevBatchesRef',
                  ParamType.DocumentReference,
                  isList: false,
                  collectionNamePath: ['batches'],
                ),
                prevBatchesStatus: params.getParam(
                  'prevBatchesStatus',
                  ParamType.String,
                ),
                presentBatchRef: params.getParam(
                  'presentBatchRef',
                  ParamType.DocumentReference,
                  isList: false,
                  collectionNamePath: ['batches'],
                ),
                presentBatchesStatus: params.getParam(
            ...
            FFRoute(
              name: 'Batch-ChangeBatch-Course',
              path: 'batchCourseListProces',
              requireAuth: true,
              builder: (context, params) => BatchChangeBatchCourseWidget(
                courseRef: params.getParam(
                  'courseRef',
                  ParamType.DocumentReference,
                  isList: false,
            ...
            FFRoute(
              ...
              builder: (context, params) => CouponEditorWidget(
                couponRef: params.getParam(
                  'couponRef',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              name: 'Video-20_09Management',
              path: 'video2009Management',
              requireAuth: true,
              asyncParams: {
                'folder': getDoc(['users'], UsersRecord.fromSnapshot),
              },
              builder: (context, params) => Video2009ManagementWidget(
                folder: params.getParam(
                  'folder',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              ...
              asyncParams: {
                ...
                'userFolder': getDoc(['users'], UsersRecord.fromSnapshot),
              },
              builder: (context, params) => VideoEditorWidget(
                ...
                playbackinfo: params.getParam(
                  'playbackinfo',
                  ParamType.String,
                ),
                userFolder: params.getParam(
                  'userFolder',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              name: 'Translation-PollList',
              path: 'translation-poll-list',
              requireAuth: true,
              builder: (context, params) => TranslationPollListWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              builder: (context, params) => ReportRevenueWidget(
                orderType: params.getParam(
                  'orderType',
                  ParamType.String,
                ),
                coupoRef: params.getParam(
                  'coupoRef',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              ...
              path: 'SalesReport',
              requireAuth: true,
              builder: (context, params) => ReportSalesWidget(),
            ),
            FFRoute(
              name: 'Order-Single',
              path: 'particular-order',
              requireAuth: true,
              asyncParams: {
                'orderRef': getDoc(['orders'], OrdersRecord.fromSnapshot),
              },
              builder: (context, params) => OrderSingleWidget(
            ...
            FFRoute(
              name: 'ManualNotification-List',
              path: 'manual-notification-list',
              requireAuth: true,
              builder: (context, params) => ManualNotificationListWidget(),
            ),
            FFRoute(
              name: 'Users',
              path: 'users',
            ...
            FFRoute(
              name: 'Log-Session',
              path: 'Session_log_user',
              requireAuth: true,
              builder: (context, params) => LogSessionWidget(),
            ),
            FFRoute(
              name: 'Log-Email',
              path: 'Email_log',
              requireAuth: true,
              builder: (context, params) => LogEmailWidget(),
            ),
            FFRoute(
              name: 'Log-EMINotification',
              path: 'EMINotificationLog',
              requireAuth: true,
              builder: (context, params) => LogEMINotificationWidget(),
            ),
            FFRoute(
              name: 'Log-Activity',
              path: 'Activity_log',
              requireAuth: true,
              builder: (context, params) => LogActivityWidget(),
            ),
            FFRoute(
              name: 'InstructorRequestBackup',
              path: 'InstructorRequestBackup',
              requireAuth: true,
              asyncParams: {
                'meetingRef': getDoc(['meeting'], MeetingRecord.fromSnapshot),
              },
              builder: (context, params) => InstructorRequestBackupWidget(
                meetingRef: params.getParam(
                  'meetingRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: 'Video-12_06_Management',
              path: 'video1206Management',
              requireAuth: true,
              builder: (context, params) => Video1206ManagementWidget(),
            ),
            FFRoute(
              name: 'Video-02_09Management',
              path: 'video29Management',
              requireAuth: true,
              asyncParams: {
                'folder': getDoc(['users'], UsersRecord.fromSnapshot),
              },
              builder: (context, params) => Video0209ManagementWidget(
                folder: params.getParam(
                  'folder',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              ...
              requireAuth: true,
              asyncParams: {
                'folder': getDoc(['folder'], FolderRecord.fromSnapshot),
              },
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  color: Colors.white,
                  child: Image.asset(
                    'assets/images/bonus-academy-logo-icon.jpg',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
