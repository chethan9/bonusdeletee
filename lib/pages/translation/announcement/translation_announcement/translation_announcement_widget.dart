...
import 'translation_announcement_model.dart';
export 'translation_announcement_model.dart';

class TranslationAnnouncementWidget extends StatefulWidget {
  const TranslationAnnouncementWidget({super.key});

  @override
  State<TranslationAnnouncementWidget> createState() =>
      _TranslationAnnouncementWidgetState();
}

class _TranslationAnnouncementWidgetState
    extends State<TranslationAnnouncementWidget> {
  late TranslationAnnouncementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationAnnouncementModel());
                                  ...
                                  child:
                                    ...
                                    stream: queryAnnouncementRecord(
                                      queryBuilder: (announcementRecord) =>
                                          announcementRecord.orderBy('title'),
                                    ),
