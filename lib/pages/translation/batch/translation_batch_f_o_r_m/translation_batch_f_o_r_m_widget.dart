...
import 'translation_batch_f_o_r_m_model.dart';
export 'translation_batch_f_o_r_m_model.dart';

class TranslationBatchFORMWidget extends StatefulWidget {
  const TranslationBatchFORMWidget({
    super.key,
  ...
  @override
  State<TranslationBatchFORMWidget> createState() =>
      _TranslationBatchFORMWidgetState();
}

class _TranslationBatchFORMWidgetState
    extends State<TranslationBatchFORMWidget> {
  late TranslationBatchFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationBatchFORMModel());
