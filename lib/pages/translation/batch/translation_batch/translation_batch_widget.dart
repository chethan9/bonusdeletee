...
import 'translation_batch_model.dart';
export 'translation_batch_model.dart';

class TranslationBatchWidget extends StatefulWidget {
  const TranslationBatchWidget({super.key});

  @override
  State<TranslationBatchWidget> createState() => _TranslationBatchWidgetState();
}

class _TranslationBatchWidgetState extends State<TranslationBatchWidget> {
  late TranslationBatchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationBatchModel());
                                          ...
                                          AuthUserStreamWidget(
                                            builder: (context) => StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<BatchesRecord>
                                                    gridViewBatchesRecordList =
                                                    snapshot.data!;
                                                if (gridViewBatchesRecordList
                                                    .isEmpty) {
                                                  return Center(
