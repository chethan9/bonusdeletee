...
import 'translation_poll_answer_f_o_r_m_model.dart';
export 'translation_poll_answer_f_o_r_m_model.dart';

class TranslationPollAnswerFORMWidget extends StatefulWidget {
  const TranslationPollAnswerFORMWidget({
    super.key,
    this.pollAnsRef,
  });

  final PollAnswerRecord? pollAnsRef;

  @override
  State<TranslationPollAnswerFORMWidget> createState() =>
      _TranslationPollAnswerFORMWidgetState();
}

class _TranslationPollAnswerFORMWidgetState
    extends State<TranslationPollAnswerFORMWidget> {
  late TranslationPollAnswerFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationPollAnswerFORMModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Title(
        title: 'TranslationPollAnswerFORM',
