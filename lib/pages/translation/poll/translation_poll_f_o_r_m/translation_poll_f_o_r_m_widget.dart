...
import 'translation_poll_f_o_r_m_model.dart';
export 'translation_poll_f_o_r_m_model.dart';

class TranslationPollFORMWidget extends StatefulWidget {
  const TranslationPollFORMWidget({
    super.key,
    this.pollRef,
  });
  ...
  @override
  State<TranslationPollFORMWidget> createState() =>
      _TranslationPollFORMWidgetState();
}

class _TranslationPollFORMWidgetState extends State<TranslationPollFORMWidget> {
  late TranslationPollFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationPollFORMModel());
    ...
    _model.inputTextController7 ??=
        TextEditingController(text: widget!.pollRef?.bioAutoTranslate?.ar);
    _model.inputFocusNode7 ??= FocusNode();

    _model.inputTextController8 ??=
        TextEditingController(text: widget!.pollRef?.questionAutoTranslate?.en);
    _model.inputFocusNode8 ??= FocusNode();

    _model.inputTextController9 ??=
        TextEditingController(text: widget!.pollRef?.questionAutoTranslate?.ar);
    _model.inputFocusNode9 ??= FocusNode();

    _model.inputTextController10 ??=
        TextEditingController(text: widget!.pollRef?.titleManualTranslate?.en);
    _model.inputFocusNode10 ??= FocusNode();

    _model.inputTextController11 ??=
        TextEditingController(text: widget!.pollRef?.titleManualTranslate?.ar);
    _model.inputFocusNode11 ??= FocusNode();

    _model.inputTextController12 ??=
        TextEditingController(text: widget!.pollRef?.bioManualTranslate?.en);
    _model.inputFocusNode12 ??= FocusNode();

    _model.inputTextController13 ??=
        TextEditingController(text: widget!.pollRef?.bioManualTranslate?.ar);
    _model.inputFocusNode13 ??= FocusNode();

    _model.inputTextController14 ??= TextEditingController(
        text: widget!.pollRef?.questionManualTranslate?.en);
    _model.inputFocusNode14 ??= FocusNode();

    _model.inputTextController15 ??= TextEditingController(
        text: widget!.pollRef?.questionManualTranslate?.ar);
