...
import 'translation_course_model.dart';
export 'translation_course_model.dart';

class TranslationCourseWidget extends StatefulWidget {
  const TranslationCourseWidget({super.key});

  @override
  State<TranslationCourseWidget> createState() =>
      _TranslationCourseWidgetState();
}

class _TranslationCourseWidgetState extends State<TranslationCourseWidget> {
  late TranslationCourseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationCourseModel());
