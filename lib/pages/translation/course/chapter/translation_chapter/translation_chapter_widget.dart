...
import 'translation_chapter_model.dart';
export 'translation_chapter_model.dart';

class TranslationChapterWidget extends StatefulWidget {
  const TranslationChapterWidget({
    super.key,
  ...
  @override
  State<TranslationChapterWidget> createState() =>
      _TranslationChapterWidgetState();
}

class _TranslationChapterWidgetState extends State<TranslationChapterWidget> {
  late TranslationChapterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationChapterModel());
                                ...
                                child: Container(
                                  ...
                                  child: StreamBuilder<List<ChapterRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<ChapterRecord>
                                          listViewChapterRecordList =
                                          snapshot.data!;
                                      if (listViewChapterRecordList.isEmpty) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewChapterRecordList.length,
                                                              ...
                                                              children: [
                                                                InkWell(
                                                                  ...
                                                                  child:
                                                                      AddButtonWidget(
                                                                    key: Key(
                                                                        'Keybjx_${listViewIndex}_of_${listViewChapterRecordList.length}'),
                                                                    text: FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'oedzjc7r' /* View Lesson */,
                                                                    ),
                                                                    icon: Icon(
                                                                      Icons
                                                                          .remove_red_eye,
