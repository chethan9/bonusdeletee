...
import 'country_f_o_r_m_model.dart';
export 'country_f_o_r_m_model.dart';
...
class _CountryFORMWidgetState extends State<CountryFORMWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CountryFORMModel());
                ...
                if ((MediaQuery.sizeOf(context).width > 1070.0) &&
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: StreamBuilder<CountryRecord>(
                          stream:
                              CountryRecord.getDocument(widget!.countryRef!),
                          builder: (context, snapshot) {
                            ...
                            final columnCountryRecord = snapshot.data!;
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              (columnCountryRecord != null) ==
                                                      true
                                                  ? columnCountryRecord.name
                                                  : 'Add Country',
                                              'Add Country',
                                            ),
