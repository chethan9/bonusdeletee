...
class _UniversityWidgetState extends State<UniversityWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UniversityModel());
                                          ...
                                          child: Container(
                                            ...
                                            child: StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<UniversityRecord>
                                                    listViewUniversityRecordList =
                                                    snapshot.data!;
                                                if (listViewUniversityRecordList
                                                    .isEmpty) {
                                                ...
                                                return ListView.builder(
                                                  ...
                                                  itemBuilder:
                                                    ...
                                                    final listViewUniversityRecord =
                                                        listViewUniversityRecordList[
                                                            listViewIndex];
                                                    return Padding(
                                                      padding:
                                                            ...
                                                            children: [
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Image
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewUniversityRecord.image,
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            context.pushNamed(
                                                                              ...
                                                                              extra: <String, dynamic>{
                                                                                ...
                                                                                'universityRef': listViewUniversityRecord,
                                                                                kTransitionInfoKey: TransitionInfo(
                                                                                  hasTransition: true,
                                                                                  transitionType: PageTransitionType.fade,
                                                                                  duration: Duration(milliseconds: 0),
                                                              ...
                                                              InkWell(
                                                                ...
                                                                child:
                                                                    AddButtonWidget(
                                                                  key: Key(
                                                                      'Keyqwe_${listViewIndex}_of_${listViewUniversityRecordList.length}'),
                                                                  text: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'cl3gbvd7' /* List Category */,
                                                                  ),
                                                                  icon: Icon(
                                                                    Icons.list,
                                                                    color: Colors
                                                              ...
                                                              InkWell(
                                                                ...
                                                                child:
                                                                    AddButtonWidget(
                                                                  key: Key(
                                                                      'Key6fq_${listViewIndex}_of_${listViewUniversityRecordList.length}'),
                                                                  text: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'jfuxi54d' /* Edit */,
