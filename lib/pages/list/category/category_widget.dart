                                                            ...
                                                            children: [
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            context.pushNamed(
                                                                              ...
                                                                              extra: <String, dynamic>{
                                                                                ...
                                                                                'categoryRef': listViewCategoryRecord,
                                                                                kTransitionInfoKey: TransitionInfo(
                                                                                  hasTransition: true,
                                                                                  transitionType: PageTransitionType.fade,
                                                                                  duration: Duration(milliseconds: 0),
                                                              ...
                                                              InkWell(
                                                                ...
                                                                child:
                                                                    AddButtonWidget(
                                                                  key: Key(
                                                                      'Keyyyk_${listViewIndex}_of_${listViewCategoryRecordList.length}'),
                                                                  text: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    '86fxzewz' /* List Branch */,
                                                                  ),
                                                                  icon: Icon(
                                                                    Icons.list,
                                                                    color: Colors
                                                              ...
                                                              InkWell(
                                                                ...
                                                                child:
                                                                    AddButtonWidget(
                                                                  key: Key(
                                                                      'Keygy2_${listViewIndex}_of_${listViewCategoryRecordList.length}'),
                                                                  text: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'rc2vg1c5' /* Edit */,
