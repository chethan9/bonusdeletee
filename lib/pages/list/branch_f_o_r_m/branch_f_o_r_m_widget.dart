...
import 'branch_f_o_r_m_model.dart';
export 'branch_f_o_r_m_model.dart';
...
class _BranchFORMWidgetState extends State<BranchFORMWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BranchFORMModel());
                      ...
                      Expanded(
                        child: StreamBuilder<BranchRecord>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final columnBranchRecord = snapshot.data!;
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              (columnBranchRecord != null) ==
                                                      true
                                                  ? columnBranchRecord.name
                                                  : 'Add Country',
                                              'Add Country',
                                            ),
