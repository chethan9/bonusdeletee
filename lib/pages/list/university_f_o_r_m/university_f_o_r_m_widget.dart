...
import 'university_f_o_r_m_model.dart';
export 'university_f_o_r_m_model.dart';
...
class _UniversityFORMWidgetState extends State<UniversityFORMWidget> {
  late UniversityFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UniversityFORMModel());
                ...
                if ((MediaQuery.sizeOf(context).width > 1070.0) &&
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: StreamBuilder<UniversityRecord>(
                          stream: UniversityRecord.getDocument(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final columnUniversityRecord = snapshot.data!;
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              (columnUniversityRecord !=
                                                          null) ==
                                                      true
                                                  ? columnUniversityRecord.name
                                                  : 'Add University',
                                              'Add University',
                                            ),
