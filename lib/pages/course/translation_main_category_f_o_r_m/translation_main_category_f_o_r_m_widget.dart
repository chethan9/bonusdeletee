...
import 'translation_main_category_f_o_r_m_model.dart';
export 'translation_main_category_f_o_r_m_model.dart';

class TranslationMainCategoryFORMWidget extends StatefulWidget {
  const TranslationMainCategoryFORMWidget({
    super.key,
    this.categoryRef,
  });
  ...
  @override
  State<TranslationMainCategoryFORMWidget> createState() =>
      _TranslationMainCategoryFORMWidgetState();
}

class _TranslationMainCategoryFORMWidgetState
    extends State<TranslationMainCategoryFORMWidget> {
  late TranslationMainCategoryFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationMainCategoryFORMModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Title(
        title: 'TranslationMainCategoryFORM',
