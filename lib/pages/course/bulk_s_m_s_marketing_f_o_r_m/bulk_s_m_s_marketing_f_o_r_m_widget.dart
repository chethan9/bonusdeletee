...
import 'bulk_s_m_s_marketing_f_o_r_m_model.dart';
export 'bulk_s_m_s_marketing_f_o_r_m_model.dart';

class BulkSMSMarketingFORMWidget extends StatefulWidget {
  const BulkSMSMarketingFORMWidget({super.key});

  @override
  State<BulkSMSMarketingFORMWidget> createState() =>
      _BulkSMSMarketingFORMWidgetState();
}

class _BulkSMSMarketingFORMWidgetState
    extends State<BulkSMSMarketingFORMWidget> {
  late BulkSMSMarketingFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BulkSMSMarketingFORMModel());
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    Builder(
                                      builder: (context) => Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            _model.mainSettingRslt =
                                                await querySettingsRecordOnce(
                                              singleRecord: true,
                                            ).then((s) => s.firstOrNull);
                                            _model.msgCountRslt =
                                                await actions.messageCount(
                                                        ...
                                                        child: Container(
                                                          width:
                                                              MediaQuery.sizeOf(
                                                                  ...
                                                                  0.25,
                                                          child:
                                                              BulkSmsConfirmationWidget(
                                                            message: _model
                                                                .inputTextController
                                                                .text,
                                                            phoneNumberList: _model
                                                                        .selectStatus ==
                                                                    'Unselected'
                                                                ? _model
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '8kc1oox0' /* "The maximum characters for SM... */,
                                  ),
                              ...
                              Padding(
                                ...
                                child: StickyHeader(
                                  ...
                                  content: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      if (_model.selectStatus == 'Unselected')
                                      ...
                                      if (_model.selectStatus == 'Selected')
                                        StreamBuilder<List<UsersRecord>>(
                                          stream: queryUsersRecord(
                                            queryBuilder: (usersRecord) =>
                                                usersRecord.where(
                                                              ...
                                                              Theme(
                                                                ...
                                                                child: Checkbox(
                                                                  ...
                                                                  onChanged:
                                                                      (newValue) async {
                                                                    safeSetState(() =>
                                                                        _model.checkboxValueMap3[listViewUsersRecord] =
                                                                            newValue!);
                                                                  },
                                                                  side:
                                                                      BorderSide(
