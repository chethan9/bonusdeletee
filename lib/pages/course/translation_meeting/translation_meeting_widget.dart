...
import 'translation_meeting_model.dart';
export 'translation_meeting_model.dart';

class TranslationMeetingWidget extends StatefulWidget {
  const TranslationMeetingWidget({super.key});

  @override
  State<TranslationMeetingWidget> createState() =>
      _TranslationMeetingWidgetState();
}

class _TranslationMeetingWidgetState extends State<TranslationMeetingWidget> {
  late TranslationMeetingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationMeetingModel());
                                          ...
                                          AuthUserStreamWidget(
                                            builder: (context) => StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<MeetingRecord>
                                                    gridViewMeetingRecordList =
                                                    snapshot.data!;
                                                if (gridViewMeetingRecordList
                                                    .isEmpty) {
                                                  return Center(
