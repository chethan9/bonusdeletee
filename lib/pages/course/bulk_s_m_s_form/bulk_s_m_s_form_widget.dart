...
import 'bulk_s_m_s_form_model.dart';
export 'bulk_s_m_s_form_model.dart';

class BulkSMSFormWidget extends StatefulWidget {
  const BulkSMSFormWidget({super.key});

  @override
  State<BulkSMSFormWidget> createState() => _BulkSMSFormWidgetState();
}

class _BulkSMSFormWidgetState extends State<BulkSMSFormWidget> {
  late BulkSMSFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BulkSMSFormModel());
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'r1tb9fr1' /* "The maximum characters for SM... */,
                                  ),
