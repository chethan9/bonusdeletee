...
import 'translation_university_f_o_r_m_model.dart';
export 'translation_university_f_o_r_m_model.dart';

class TranslationUniversityFORMWidget extends StatefulWidget {
  const TranslationUniversityFORMWidget({
    super.key,
    this.universityRef,
  });
  ...
  @override
  State<TranslationUniversityFORMWidget> createState() =>
      _TranslationUniversityFORMWidgetState();
}

class _TranslationUniversityFORMWidgetState
    extends State<TranslationUniversityFORMWidget> {
  late TranslationUniversityFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationUniversityFORMModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Title(
        title: 'TranslationUniversityFORM',
