...
import 'translation_lesson_model.dart';
export 'translation_lesson_model.dart';

class TranslationLessonWidget extends StatefulWidget {
  const TranslationLessonWidget({
    super.key,
  ...
  @override
  State<TranslationLessonWidget> createState() =>
      _TranslationLessonWidgetState();
}

class _TranslationLessonWidgetState extends State<TranslationLessonWidget> {
  late TranslationLessonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationLessonModel());
                                                              ...
                                                              children: [
                                                                InkWell(
                                                                  ...
                                                                  child:
                                                                      AddButtonWidget(
                                                                    key: Key(
                                                                        'Key3z5_${listViewIndex}_of_${listViewLessonsRecordList.length}'),
                                                                    text: FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'e6muuee7' /* View Zoom Lesson */,
                                                                    ),
                                                                    icon: Icon(
                                                                      Icons
