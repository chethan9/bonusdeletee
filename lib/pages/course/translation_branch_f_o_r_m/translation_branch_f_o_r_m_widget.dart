...
import 'translation_branch_f_o_r_m_model.dart';
export 'translation_branch_f_o_r_m_model.dart';

class TranslationBranchFORMWidget extends StatefulWidget {
  const TranslationBranchFORMWidget({
    super.key,
    this.branchRef,
  });
  ...
  @override
  State<TranslationBranchFORMWidget> createState() =>
      _TranslationBranchFORMWidgetState();
}

class _TranslationBranchFORMWidgetState
    extends State<TranslationBranchFORMWidget> {
  late TranslationBranchFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationBranchFORMModel());
    ...
    _model.inputTextController1 ??=
        TextEditingController(text: widget!.branchRef?.name);
    _model.inputFocusNode1 ??= FocusNode();

    _model.inputTextController2 ??=
        TextEditingController(text: widget!.branchRef?.nameAutoTranslate?.en);
    _model.inputFocusNode2 ??= FocusNode();

    _model.inputTextController3 ??=
        TextEditingController(text: widget!.branchRef?.nameAutoTranslate?.ar);
    _model.inputFocusNode3 ??= FocusNode();

    _model.inputTextController4 ??=
        TextEditingController(text: widget!.branchRef?.nameManualTranslate?.en);
    _model.inputFocusNode4 ??= FocusNode();

    _model.inputTextController5 ??=
        TextEditingController(text: widget!.branchRef?.nameManualTranslate?.ar);
