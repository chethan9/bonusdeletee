...
import 'translation_lesson_f_o_r_m_model.dart';
export 'translation_lesson_f_o_r_m_model.dart';

class TranslationLessonFORMWidget extends StatefulWidget {
  const TranslationLessonFORMWidget({
    super.key,
    this.lessonRef,
  });
  ...
  @override
  State<TranslationLessonFORMWidget> createState() =>
      _TranslationLessonFORMWidgetState();
}

class _TranslationLessonFORMWidgetState
    extends State<TranslationLessonFORMWidget> {
  late TranslationLessonFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationLessonFORMModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ChapterRecord>(
      stream: ChapterRecord.getDocument(widget!.lessonRef!.chapterRef!),
      builder: (context, snapshot) {
        ...
        final translationLessonFORMChapterRecord = snapshot.data!;

        return Title(
            title: 'TranslationLessonFORM',
                          ...
                          if (responsiveVisibility(
                            ...
                            wrapWithModel(
                              ...
                              child: WebNavWidget(
                                ...
                                colorBgNighteen: FlutterFlowTheme.of(context)
                                    .primaryBackground,
                              ),
                            ),
                          Container(
                                              ...
                                              onPressed: () async {
                                                context.pushNamed(
                                                  ...
                                                  queryParameters: {
                                                    'chapterRef':
                                                        serializeParam(
                                                      translationLessonFORMChapterRecord,
                                                      ParamType.Document,
                                                    ),
                                                  }.withoutNulls,
                                                  extra: <String, dynamic>{
