...
import 'translation_main_category_model.dart';
export 'translation_main_category_model.dart';

class TranslationMainCategoryWidget extends StatefulWidget {
  const TranslationMainCategoryWidget({super.key});

  @override
  State<TranslationMainCategoryWidget> createState() =>
      _TranslationMainCategoryWidgetState();
}

class _TranslationMainCategoryWidgetState
    extends State<TranslationMainCategoryWidget> {
  late TranslationMainCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationMainCategoryModel());
