...
import 'translation_country_model.dart';
export 'translation_country_model.dart';

class TranslationCountryWidget extends StatefulWidget {
  const TranslationCountryWidget({super.key});

  @override
  State<TranslationCountryWidget> createState() =>
      _TranslationCountryWidgetState();
}

class _TranslationCountryWidgetState extends State<TranslationCountryWidget> {
  late TranslationCountryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationCountryModel());
