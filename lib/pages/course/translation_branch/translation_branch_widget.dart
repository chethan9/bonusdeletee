...
import 'translation_branch_model.dart';
export 'translation_branch_model.dart';

class TranslationBranchWidget extends StatefulWidget {
  const TranslationBranchWidget({super.key});

  @override
  State<TranslationBranchWidget> createState() =>
      _TranslationBranchWidgetState();
}

class _TranslationBranchWidgetState extends State<TranslationBranchWidget> {
  late TranslationBranchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationBranchModel());
                                          ...
                                          AuthUserStreamWidget(
                                            builder: (context) => StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<BranchRecord>
                                                    gridViewBranchRecordList =
                                                    snapshot.data!;
                                                if (gridViewBranchRecordList
                                                    .isEmpty) {
                                                  return Center(
