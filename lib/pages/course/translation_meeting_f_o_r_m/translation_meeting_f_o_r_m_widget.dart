...
import 'translation_meeting_f_o_r_m_model.dart';
export 'translation_meeting_f_o_r_m_model.dart';

class TranslationMeetingFORMWidget extends StatefulWidget {
  const TranslationMeetingFORMWidget({
    super.key,
    this.meetingRef,
  });
  ...
  @override
  State<TranslationMeetingFORMWidget> createState() =>
      _TranslationMeetingFORMWidgetState();
}

class _TranslationMeetingFORMWidgetState
    extends State<TranslationMeetingFORMWidget> {
  late TranslationMeetingFORMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TranslationMeetingFORMModel());
