...
class _AddUserWidgetState extends State<AddUserWidget> {
  ...
  void initState() {
    ...
    _model.yourPhnTextController ??= TextEditingController();
                    ...
                    Expanded(
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            20.0, 0.0, 20.0, 16.0),
                        child: TextFormField(
                          controller: _model.yourPhnTextController,
                          focusNode: _model.yourPhnFocusNode,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              'zzsmfqnu' /* Phone Number */,
                            ),
                            labelStyle: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
                          ...
                          maxLines: null,
                          validator: _model.yourPhnTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
