...
import 'onboard_phone_model.dart';
export 'onboard_phone_model.dart';

class OnboardPhoneWidget extends StatefulWidget {
  const OnboardPhoneWidget({super.key});

  @override
  State<OnboardPhoneWidget> createState() => _OnboardPhoneWidgetState();
}

class _OnboardPhoneWidgetState extends State<OnboardPhoneWidget> {
  late OnboardPhoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardPhoneModel());
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            final phoneNumberVal =
                                                '${functions.getDialCode(_model.dropDownValue)}${_model.phoneFieldTextController.text}';
