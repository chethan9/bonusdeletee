...
class _VideoEditorWidgetState extends State<VideoEditorWidget> {
  ...
  void initState() {
    ...
    _model.inputTextController1 ??=
        TextEditingController(text: widget!.videoRef?.title);
    _model.inputFocusNode1 ??= FocusNode();

    _model.inputTextController2 ??=
        TextEditingController(text: widget!.videoRef?.description);
                                                          ...
                                                          Text(
                                                            '${((int.parse(valueOrDefault<String>(
                                                                  widget!
                                                                      ...
                                                                      ?.duration,
                                                                  '0',
                                                                )) / 60).floor()).toString()} min ${((((int.parse(valueOrDefault<String>(
                                                                  widget!
                                                                      .videoRef
                                                                      ?.duration,
                                                                  '0',
                                                                )) / 60) - (int.parse(valueOrDefault<String>(
                                                                  widget!
                                                                      .videoRef
                                                                      ?.duration,
                                                                  '0',
                                                                )) / 60).truncate()) * 60).round()).toString()} sec',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                                .override(
                                                ...
                                                children: [
                                                  ...
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      ...
                                                      if ((_model.apiResult9el
                                                              ?.succeeded ??
                                                          true)) {
                                                        _model.apiResultu77 =
                                                            await ChangeFeatureImageCall
                                                                .call(
                                                          videoId: widget!
                                                              .videoRef
                                                              ?.videoId,
                                                        ...
                                                        if ((_model.apiResultu77
                                                                ?.succeeded ??
                                                            true)) {
                                                          _model.apiResultf9c =
                                                              await CheckVideoStatusCall
                                                                  .call(
                                                            videoID: widget!
                                                                .videoRef
                                                                ?.videoId,
                                                          ...
                                                          if ((_model
                                                            ...
                                                            ScaffoldMessenger
                                                              ...
                                                              SnackBar(
                                                                content: Text(
                                                                  'Failed in the video image update (API-E002).',
                                                                  style:
                                                                      TextStyle(
                                                                    color: FlutterFlowTheme.of(
                                                                            context)
                                                          ...
                                                          ScaffoldMessenger.of(
                                                            ...
                                                            SnackBar(
                                                              content: Text(
                                                                'Video was updated successfully (1).',
                                                                style:
                                                                    TextStyle(
                                                                  color: FlutterFlowTheme.of(
                                                                          context)
