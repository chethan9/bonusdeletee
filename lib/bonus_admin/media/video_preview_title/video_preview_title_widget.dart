...
import 'video_preview_title_model.dart';
export 'video_preview_title_model.dart';

class VideoPreviewTitleWidget extends StatefulWidget {
  const VideoPreviewTitleWidget({
    super.key,
  ...
  @override
  State<VideoPreviewTitleWidget> createState() =>
      _VideoPreviewTitleWidgetState();
}

class _VideoPreviewTitleWidgetState extends State<VideoPreviewTitleWidget> {
  late VideoPreviewTitleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoPreviewTitleModel());
