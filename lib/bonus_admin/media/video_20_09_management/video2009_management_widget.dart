...
import 'video2009_management_model.dart';
export 'video2009_management_model.dart';

class Video2009ManagementWidget extends StatefulWidget {
  const Video2009ManagementWidget({
    super.key,
    this.folder,
  });
  ...
  @override
  State<Video2009ManagementWidget> createState() =>
      _Video2009ManagementWidgetState();
}

class _Video2009ManagementWidgetState extends State<Video2009ManagementWidget>
    with TickerProviderStateMixin {
  late Video2009ManagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Video2009ManagementModel());
        ...
        if ((_model.userAuthRslt1 != null) == true) {
          if (_model.userAuthRslt1?.userRole == 'Instructor') {
            ...
            if ((_model.userFolderStatusRslt1?.succeeded ?? true)) {
              if (_model.userAuthRslt1?.instructorFolderID == null ||
