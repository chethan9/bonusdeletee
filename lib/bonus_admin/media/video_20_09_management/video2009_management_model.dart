...
import 'video2009_management_widget.dart' show Video2009ManagementWidget;
...
class Video2009ManagementModel
    extends FlutterFlowModel<Video2009ManagementWidget> {
  ...
  // Stores action output result for [Backend Call - Read Document] action in Video-20_09Management widget.
  UsersRecord? userAuthRslt1;
  // Stores action output result for [Backend Call - API (Search by Folder Name)] action in Video-20_09Management widget.
  ApiCallResponse? userFolderStatusRslt1;
  // Stores action output result for [Backend Call - API (Create Folder)] action in Video-20_09Management widget.
  ApiCallResponse? userFolderCreationRslt1;
  // Stores action output result for [Backend Call - API (List Video based FolderID)] action in Video-20_09Management widget.
  ApiCallResponse? userFolderVideoListRslt1;
  // Stores action output result for [Backend Call - API (Folder List)] action in Video-20_09Management widget.
