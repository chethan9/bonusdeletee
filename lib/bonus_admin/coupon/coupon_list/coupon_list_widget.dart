                                      ...
                                      child: StreamBuilder<List<CouponRecord>>(
                                        stream: queryCouponRecord(
                                          queryBuilder: (couponRecord) =>
                                              couponRecord.orderBy('startDate',
                                                  descending: true),
                                        ),
                                                    ...
                                                    dataRowBuilder: (c1Item,
                                                      ...
                                                      cells: [
                                                        ...
                                                        Text(
                                                          c1Item.type ==
                                                                  'Amount'
                                                              ? '${c1Item.amount.toString()}KD'
                                                              : '${c1Item.discount.toString()}%',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                        ...
                                                        Text(
                                                          '${c1Item.usage.toString()} / ${c1Item.totalUsage.toString()}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
