...
import 'coupon_editor_model.dart';
export 'coupon_editor_model.dart';

class CouponEditorWidget extends StatefulWidget {
  const CouponEditorWidget({
    super.key,
    this.couponRef,
  });
  ...
  @override
  State<CouponEditorWidget> createState() => _CouponEditorWidgetState();
}

class _CouponEditorWidgetState extends State<CouponEditorWidget> {
  late CouponEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CouponEditorModel());
                                      ...
                                      if (_model.dropDownValue == 'Discount') {
                                        if (!functions
                                            .returnCouponStatusForPrice(
                                                ...
                                                double.parse(_model
                                                    .inputTextController4.text),
                                                double.parse(_model
                                                    .inputTextController5.text),
                                                'DIS')) {
                                          await showDialog(
                                            context: context,
