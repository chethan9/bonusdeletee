...
import 'batch_course_creat_time_popup_model.dart';
export 'batch_course_creat_time_popup_model.dart';

class BatchCourseCreatTimePopupWidget extends StatefulWidget {
  const BatchCourseCreatTimePopupWidget({
    super.key,
  ...
  @override
  State<BatchCourseCreatTimePopupWidget> createState() =>
      _BatchCourseCreatTimePopupWidgetState();
}

class _BatchCourseCreatTimePopupWidgetState
    extends State<BatchCourseCreatTimePopupWidget> {
  late BatchCourseCreatTimePopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BatchCourseCreatTimePopupModel());
