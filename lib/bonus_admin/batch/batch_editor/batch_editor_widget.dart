...
import 'batch_editor_model.dart';
export 'batch_editor_model.dart';

class BatchEditorWidget extends StatefulWidget {
  const BatchEditorWidget({
    super.key,
    this.batchRef,
  });
  ...
  @override
  State<BatchEditorWidget> createState() => _BatchEditorWidgetState();
}

class _BatchEditorWidgetState extends State<BatchEditorWidget> {
  late BatchEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BatchEditorModel());
