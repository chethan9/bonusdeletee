...
import 'batch_course_creat_time_batch_list_model.dart';
export 'batch_course_creat_time_batch_list_model.dart';

class BatchCourseCreatTimeBatchListWidget extends StatefulWidget {
  const BatchCourseCreatTimeBatchListWidget({
    super.key,
  ...
  @override
  State<BatchCourseCreatTimeBatchListWidget> createState() =>
      _BatchCourseCreatTimeBatchListWidgetState();
}

class _BatchCourseCreatTimeBatchListWidgetState
    extends State<BatchCourseCreatTimeBatchListWidget> {
  late BatchCourseCreatTimeBatchListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BatchCourseCreatTimeBatchListModel());
