...
import 'batch_add_model.dart';
export 'batch_add_model.dart';

class BatchAddWidget extends StatefulWidget {
  const BatchAddWidget({
    super.key,
    this.courseRef,
  });
  ...
  @override
  State<BatchAddWidget> createState() => _BatchAddWidgetState();
}

class _BatchAddWidgetState extends State<BatchAddWidget> {
  late BatchAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BatchAddModel());
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 16.0),
                              child: TextFormField(
                                controller: _model.bookingLimitTextController,
