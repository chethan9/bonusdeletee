...
import 'meeting_add_model.dart';
export 'meeting_add_model.dart';

class MeetingAddWidget extends StatefulWidget {
  const MeetingAddWidget({super.key});

  @override
  State<MeetingAddWidget> createState() => _MeetingAddWidgetState();
}

class _MeetingAddWidgetState extends State<MeetingAddWidget> {
  late MeetingAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeetingAddModel());
