...
import 'meeting_editor_model.dart';
export 'meeting_editor_model.dart';

class MeetingEditorWidget extends StatefulWidget {
  const MeetingEditorWidget({
    super.key,
    this.meetingRef,
  });
  ...
  @override
  State<MeetingEditorWidget> createState() => _MeetingEditorWidgetState();
}

class _MeetingEditorWidgetState extends State<MeetingEditorWidget>
    with TickerProviderStateMixin {
  late MeetingEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeetingEditorModel());
    ...
    _model.limitTextController ??=
        TextEditingController(text: widget!.meetingRef?.slotLimit?.toString());
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    await widget!.meetingRef!.reference.update({
                                      ...createMeetingRecordData(
                                        title: _model.inputTextController.text,
                                        startDate:
                                            _model.calendarSelectedDay?.start,
                                        slotLimit: int.tryParse(
                                            _model.limitTextController.text),
                                      ),
                                      ...mapToFirestore(
                                        {
                                          'dayList':
                                    ...
                                    await ActivityLogRecord.collection
                                      ...
                                      ...createActivityLogRecordData(
                                        ...
                                        object: 'Meeting',
                                        eventId:
                                            widget!.meetingRef?.reference.id,
                                        eventTitle:
