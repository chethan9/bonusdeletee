...
import 'log_e_m_i_notification_model.dart';
export 'log_e_m_i_notification_model.dart';

class LogEMINotificationWidget extends StatefulWidget {
  const LogEMINotificationWidget({super.key});

  @override
  State<LogEMINotificationWidget> createState() =>
      _LogEMINotificationWidgetState();
}

class _LogEMINotificationWidgetState extends State<LogEMINotificationWidget> {
  late LogEMINotificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LogEMINotificationModel());
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 8.0, 16.0, 0.0),
                                      child: StreamBuilder<
                                          List<AlertSubscriberRecord>>(
                                        stream: queryAlertSubscriberRecord(
                                          queryBuilder:
                                              (alertSubscriberRecord) =>
                                                  alertSubscriberRecord.orderBy(
                                                      'created_at',
                                                      descending: true),
                                        ),
                                        builder: (context, snapshot) {
                                          ...
                                          List<AlertSubscriberRecord>
                                              emailnotificationlogAlertSubscriberRecordList =
                                              snapshot.data!;
