...
import 'manual_notification_list_model.dart';
export 'manual_notification_list_model.dart';

class ManualNotificationListWidget extends StatefulWidget {
  const ManualNotificationListWidget({super.key});

  @override
  State<ManualNotificationListWidget> createState() =>
      _ManualNotificationListWidgetState();
}

class _ManualNotificationListWidgetState
    extends State<ManualNotificationListWidget> {
  late ManualNotificationListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManualNotificationListModel());
                        ...
                        if (responsiveVisibility(
                          ...
                          wrapWithModel(
                            ...
                            child: WebNavWidget(
                              ...
                              colorBgEighteen: FlutterFlowTheme.of(context)
                                  .primaryBackground,
                            ),
                          ),
                        Container(
                                        ...
                                        content: PagedListView<
                                          ...
                                          builderDelegate:
                                            ...
                                            itemBuilder:
                                              ...
                                              final listViewManualAlertSubscriberRecord =
                                                  _model
                                                                  ...
                                                                  if (responsiveVisibility(
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        dateTimeFormat(
                                                                          "yMMMd",
                                                                          listViewManualAlertSubscriberRecord
                                                                              .createdAt!,
                                                                          locale:
                                                                  ...
                                                                  Builder(
                                                                    builder:
                                                                            ...
                                                                            return Dialog(
                                                                              ...
                                                                              child: WebViewAware(
                                                                                child: GestureDetector(
                                                                                  ...
                                                                                  child: Container(
                                                                                    width: 500.0,
                                                                                    child: ManualNotificationReportWidget(
                                                                                      manual: listViewManualAlertSubscriberRecord,
                                                                                    ),
                                                                                  ),
                                                                                ),
                                                                              ),
                                                                      ...
                                                                      child:
                                                                          AddButtonWidget(
                                                                        key: Key(
                                                                            'Key9uj_${listViewIndex}_of_${_model.listViewPagingController!.itemList!.length}'),
