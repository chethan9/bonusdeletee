...
import 'report_revenue_model.dart';
export 'report_revenue_model.dart';

class ReportRevenueWidget extends StatefulWidget {
  const ReportRevenueWidget({
    super.key,
    this.orderType,
    this.coupoRef,
  });
  ...
  @override
  State<ReportRevenueWidget> createState() => _ReportRevenueWidgetState();
}

class _ReportRevenueWidgetState extends State<ReportRevenueWidget>
    with TickerProviderStateMixin {
  late ReportRevenueModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportRevenueModel());
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children:
                                                                            ...
                                                                            children: [
                                                                              Align(
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Text(
                                                                                    '${functions.newCartTotal(listViewOrdersRecord.orderItems.map((e) => e.subTotal).toList()).toString()} KWD',
                                                                        ...
                                                                        if (listViewOrdersRecord.couponRef !=
                                                                            null)
                                                                          Expanded(
                                                                            child:
                                                                                Wrap(
                                                                              ...
                                                                              children: [
                                                                                StreamBuilder<CouponRecord>(
                                                                                  stream: CouponRecord.getDocument(listViewOrdersRecord.couponRef!),
                                                                                  builder: (context, snapshot) {
                                                                                    ...
                                                                                    final textCouponRecord = snapshot.data!;

                                                                                    return Text(
                                                                                      textCouponRecord.name,
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                            color: FlutterFlowTheme.of(context).primaryText,
                                                                                            letterSpacing: 0.0,
