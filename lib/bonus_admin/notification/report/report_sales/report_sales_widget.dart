...
import 'report_sales_model.dart';
export 'report_sales_model.dart';

class ReportSalesWidget extends StatefulWidget {
  const ReportSalesWidget({super.key});

  @override
  State<ReportSalesWidget> createState() => _ReportSalesWidgetState();
}

class _ReportSalesWidgetState extends State<ReportSalesWidget>
    with TickerProviderStateMixin {
  late ReportSalesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportSalesModel());
                                                              ...
                                                              stream:
                                                                ...
                                                                queryBuilder: (ordersRecord) =>
                                                                    ordersRecord
                                                                        .where(
                                                                          'createdAt',
                                                                          isGreaterThanOrEqualTo: _model.fromDate != null
                                                                              ? _model.fromDate
                                                                              : functions.getDateForSales(getCurrentTimestamp, 14),
                                                                        )
                                                                        .where(
                                                                          'createdAt',
                                                                          isLessThanOrEqualTo: _model.toDate != null
                                                                              ? functions.getDateForSubscription(_model.toDate!, 1)
                                                                              : functions.getDateForSubscription(getCurrentTimestamp, 1),
                                                                        )
                                                                        .where(
                                                                          'status',
                                                                          isEqualTo:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              Expanded(
                                                                                child: Builder(
                                                                                  builder: (context) {
                                                                                    final itemsList1 = listViewOrdersRecord.item.toList();
                                                                                    ...
                                                                                    return ListView.builder(
                                                                                      ...
                                                                                      itemBuilder: (context, itemsList1Index) {
                                                                                        final itemsList1Item = itemsList1[itemsList1Index];
                                                                                        return StreamBuilder<CourseRecord>(
                                                                                          stream: CourseRecord.getDocument(itemsList1Item),
                                                                                          builder: (context, snapshot) {
                                                                                            // Customize what your widget looks like when it's loading.
                                                                                            if (!snapshot.hasData) {
                                                                                              return Center(
                                                                              ...
                                                                              Expanded(
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    Text(
                                                                                      listViewOrdersRecord.item.length.toString(),
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                            color: FlutterFlowTheme.of(context).primaryText,
                                                                                            letterSpacing: 0.0,
                                                                                    ...
                                                                                    Expanded(
                                                                                      child: Column(
                                                                                        ...
                                                                                        children: [
                                                                                          ...
                                                                                          if (listViewOrdersRecord.paymenttype == 'Coupon')
                                                                                            Text(
                                                                                              '(${listViewOrdersRecord.paymenttype})',
                                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                    fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                                    letterSpacing: 0.0,
                                                                                                    useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).bodyMediumFamily),
