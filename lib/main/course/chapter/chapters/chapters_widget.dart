...
import '/main/course/chapter/create_chapter/create_chapter_widget.dart';
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            context.pushNamed(
                                                                              ...
                                                                              extra: <String, dynamic>{
                                                                                'chapterRef': listViewChapterRecord,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  '${listViewChapterRecord.serialNumber.toString()}:',
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              AutoSizeText(
                                                                            listViewChapterRecord.description.maybeHandleOverflow(
                                                                              maxChars: 65,
                                                                              replacement: '…',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).titleMedium.override(
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            ToggleIcon(
                                                                              onPressed: () async {
                                                                                await listViewChapterRecord.reference.update({
                                                                                  ...mapToFirestore(
                                                                                    {
                                                                                      'status': !listViewChapterRecord.status,
                                                                                    },
                                                                                  ),
                                                                                });
                                                                                if (listViewChapterRecord.status == true) {
                                                                                  await listViewChapterRecord.reference.update(createChapterRecordData(
                                                                                    status: false,
                                                                                  ));
                                                                                } else {
                                                                                  await listViewChapterRecord.reference.update(createChapterRecordData(
                                                                              ...
                                                                              value: listViewChapterRecord.status,
                                                                              onIcon: Icon(
                                                                                Icons.lock,
                                                                                color: Color(0xFFFF0F02),
                                                                                size: 25.0,
                                                                              ),
                                                                              offIcon: Icon(
                                                                                Icons.lock_open,
                                                                            ...
                                                                            InkWell(
                                                                              ...
                                                                              child: AddButtonWidget(
                                                                                key: Key('Keygjl_${listViewIndex}_of_${listViewChapterRecordList.length}'),
                                                                                text: FFLocalizations.of(context).getText(
                                                                                  '71mzl4jt' /* View Lesson */,
                                                                                ),
                                                                                icon: Icon(
                                                                            ...
                                                                            InkWell(
                                                                              ...
                                                                              child: AddButtonWidget(
                                                                                key: Key('Keybc4_${listViewIndex}_of_${listViewChapterRecordList.length}'),
                                                                                text: FFLocalizations.of(context).getText(
                                                                                  'ius35mbo' /* Edit */,
                                                                                ),
                                                                                icon: Icon(
