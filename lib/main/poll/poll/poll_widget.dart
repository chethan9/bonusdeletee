                                    ...
                                    Builder(
                                      builder: (context) => FutureBuilder<int>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          int addButtonCount = snapshot.data!;
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) =>
                                      ...
                                      stream: queryPollRecord(
                                        queryBuilder: (pollRecord) => pollRecord
                                            .where(
                                              'authRef',
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<PollRecord>
                                            ...
                                            snapshot.data!;
                                        if (gridViewPollRecordList.isEmpty) {
