...
class CourseRecord extends FirestoreRecord {
  ...
  // "numDaysSecondEMI_email" field.
  int? _numDaysSecondEMIEmail;
  int get numDaysSecondEMIEmail => _numDaysSecondEMIEmail ?? 0;
  bool hasNumDaysSecondEMIEmail() => _numDaysSecondEMIEmail != null;

  // "numDaysThirdEMI_email" field.
  int? _numDaysThirdEMIEmail;
  int get numDaysThirdEMIEmail => _numDaysThirdEMIEmail ?? 0;
  bool hasNumDaysThirdEMIEmail() => _numDaysThirdEMIEmail != null;

  // "dateSecondEMI_email" field.
  DateTime? _dateSecondEMIEmail;
  DateTime? get dateSecondEMIEmail => _dateSecondEMIEmail;
  bool hasDateSecondEMIEmail() => _dateSecondEMIEmail != null;

  // "dateThirdEMI_email" field.
  DateTime? _dateThirdEMIEmail;
  DateTime? get dateThirdEMIEmail => _dateThirdEMIEmail;
  bool hasDateThirdEMIEmail() => _dateThirdEMIEmail != null;
  ...
  void _initializeFields() {
    ...
    _numDaysSecondEMIEmail =
        castToType<int>(snapshotData['numDaysSecondEMI_email']);
    _numDaysThirdEMIEmail =
        castToType<int>(snapshotData['numDaysThirdEMI_email']);
    _dateSecondEMIEmail = snapshotData['dateSecondEMI_email'] as DateTime?;
    _dateThirdEMIEmail = snapshotData['dateThirdEMI_email'] as DateTime?;
  }
...
Map<String, dynamic> createCourseRecordData({
  ...
  int? numDaysSecondEMIEmail,
  int? numDaysThirdEMIEmail,
  DateTime? dateSecondEMIEmail,
  DateTime? dateThirdEMIEmail,
}) {
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'numDaysSecondEMI_email': numDaysSecondEMIEmail,
      'numDaysThirdEMI_email': numDaysThirdEMIEmail,
      'dateSecondEMI_email': dateSecondEMIEmail,
      'dateThirdEMI_email': dateThirdEMIEmail,
    }.withoutNulls,
  );
...
class CourseRecordDocumentEquality implements Equality<CourseRecord> {
  ...
  bool equals(CourseRecord? e1, CourseRecord? e2) {
    ...
    return e1?.name == e2?.name &&
        ...
        e1?.numDaysSecondEMIEmail == e2?.numDaysSecondEMIEmail &&
        e1?.numDaysThirdEMIEmail == e2?.numDaysThirdEMIEmail &&
        e1?.dateSecondEMIEmail == e2?.dateSecondEMIEmail &&
        e1?.dateThirdEMIEmail == e2?.dateThirdEMIEmail;
  }
  ...
  int hash(CourseRecord? e) => const ListEquality().hash([
        ...
        e?.sku,
        e?.emiPaymentStatus,
        e?.numDaysSecondEMIEmail,
        e?.numDaysThirdEMIEmail,
        e?.dateSecondEMIEmail,
        e?.dateThirdEMIEmail
      ]);
