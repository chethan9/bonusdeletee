      ...
      UsersRecord.getDocumentFromData(
        {
          ...
          'userSex': snapshot.data['userSex'],
          'countryRef': convertAlgoliaParam(
            snapshot.data['countryRef'],
            ParamType.DocumentReference,
            false,
          ),
          'universityRef': convertAlgoliaParam(
            snapshot.data['universityRef'],
            ParamType.DocumentReference,
            false,
          ),
          'branchRef': convertAlgoliaParam(
            snapshot.data['branchRef'],
            ParamType.DocumentReference,
            false,
          ),
          'fvrtCourseList': safeGet(
            () => convertAlgoliaParam<DocumentReference>(
              snapshot.data['fvrtCourseList'],
              ParamType.DocumentReference,
              true,
            ).toList(),
          ),
          ...
          'facebookSocialLink': snapshot.data['facebookSocialLink'],
          'instagramSocialLink': snapshot.data['instagramSocialLink'],
          'linkedinSocialLink': snapshot.data['linkedinSocialLink'],
          'instuctorStatus': snapshot.data['instuctorStatus'],
          'courseLevel': InstructorCourseLevelStruct.fromAlgoliaData(
                  snapshot.data['courseLevel'] ?? {})
              .toMap(),
          'firstName': snapshot.data['firstName'],
          'middleName': snapshot.data['middleName'],
          'lastName': snapshot.data['lastName'],
          'zoom': ZoomConfigStruct.fromAlgoliaData(snapshot.data['zoom'] ?? {})
              .toMap(),
          'blockReason': snapshot.data['blockReason'],
          'instructorRejectReason': snapshot.data['instructorRejectReason'],
          ...
          'phoneRegAttempt': convertAlgoliaParam(
            snapshot.data['phoneRegAttempt'],
            ParamType.int,
            false,
          ),
          'phoneVerified': snapshot.data['phoneVerified'],
          'categoryRef': convertAlgoliaParam(
            snapshot.data['categoryRef'],
            ParamType.DocumentReference,
            false,
          ),
          ...
          'welcomeStatus': snapshot.data['welcomeStatus'],
          'emailVerifed': snapshot.data['emailVerifed'],
          'instructorFolderID': snapshot.data['instructorFolderID'],
          'instructorFolderStatus': snapshot.data['instructorFolderStatus'],
          'folderID': snapshot.data['folderID'],
        },
