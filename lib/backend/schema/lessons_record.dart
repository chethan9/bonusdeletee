...
class LessonsRecord extends FirestoreRecord {
  ...
  // "lesson_file_list" field.
  List<LessonFileListStruct>? _lessonFileList;
  List<LessonFileListStruct> get lessonFileList => _lessonFileList ?? const [];
  bool hasLessonFileList() => _lessonFileList != null;

  // "lesson_lock_status" field.
  bool? _lessonLockStatus;
  bool get lessonLockStatus => _lessonLockStatus ?? false;
  bool hasLessonLockStatus() => _lessonLockStatus != null;
  ...
  void _initializeFields() {
    ...
    _lessonFileList = getStructList(
      snapshotData['lesson_file_list'],
      LessonFileListStruct.fromMap,
    );
    _lessonLockStatus = snapshotData['lesson_lock_status'] as bool?;
  }
...
Map<String, dynamic> createLessonsRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'lesson_lock_status': lessonLockStatus,
    }.withoutNulls,
  );
...
class LessonsRecordDocumentEquality implements Equality<LessonsRecord> {
  ...
  bool equals(LessonsRecord? e1, LessonsRecord? e2) {
    ...
    return e1?.courseRef == e2?.courseRef &&
        ...
        listEquality.equals(e1?.lessonFileList, e2?.lessonFileList) &&
        e1?.lessonLockStatus == e2?.lessonLockStatus;
  }
