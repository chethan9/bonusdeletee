...
class VideosRecord extends FirestoreRecord {
  ...
  // "fileSizeMB" field.
  double? _fileSizeMB;
  double get fileSizeMB => _fileSizeMB ?? 0.0;
  bool hasFileSizeMB() => _fileSizeMB != null;
  ...
  void _initializeFields() {
    ...
    _fileSizeMB = castToType<double>(snapshotData['fileSizeMB']);
