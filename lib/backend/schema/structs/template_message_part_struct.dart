...
class TemplateMessagePartStruct extends FFFirebaseStruct {
  ...
  set imageCourse(String? val) => _imageCourse = val;
  ...
  static TemplateMessagePartStruct fromMap(Map<String, dynamic> data) =>
      TemplateMessagePartStruct(
        ...
        imageCourse: data['imageCourse'] as String?,
      );
  ...
  static TemplateMessagePartStruct fromAlgoliaData(Map<String, dynamic> data) =>
      TemplateMessagePartStruct(
        ...
        info1: convertAlgoliaParam(
          data['info1'],
          ParamType.String,
          false,
        ),
        info2: convertAlgoliaParam(
          data['info2'],
          ParamType.String,
          false,
        ),
        imageCourse: convertAlgoliaParam(
          data['imageCourse'],
          ParamType.String,
          false,
        ),
