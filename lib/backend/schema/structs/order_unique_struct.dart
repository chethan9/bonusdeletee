...
class OrderUniqueStruct extends FFFirebaseStruct {
  ...
  void incrementLabelnum(int amount) => labelnum = labelnum + amount;
  ...
  static OrderUniqueStruct fromAlgoliaData(Map<String, dynamic> data) =>
      OrderUniqueStruct(
