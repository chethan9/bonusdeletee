...
class OnBoardStruct extends FFFirebaseStruct {
  ...
  static OnBoardStruct fromAlgoliaData(Map<String, dynamic> data) =>
      OnBoardStruct(
        ...
        bgImageStatus: convertAlgoliaParam(
          data['bgImageStatus'],
          ParamType.bool,
          false,
        ),
        bgImage: convertAlgoliaParam(
          data['bgImage'],
          ParamType.String,
          false,
        ),
        bgColor: convertAlgoliaParam(
          data['bgColor'],
          ParamType.Color,
          false,
        ),
        logoTitleReplaceStatus: convertAlgoliaParam(
          data['logoTitleReplaceStatus'],
          ParamType.bool,
          false,
        ),
