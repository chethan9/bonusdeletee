...
class InstructorCourseLevelStruct extends FFFirebaseStruct {
  ...
  static InstructorCourseLevelStruct fromAlgoliaData(
          Map<String, dynamic> data) =>
      InstructorCourseLevelStruct(
        coutryRef: convertAlgoliaParam(
          data['coutryRef'],
          ParamType.DocumentReference,
          false,
        ),
        ...
        countryName: convertAlgoliaParam(
          data['countryName'],
          ParamType.String,
          false,
        ),
        universityName: convertAlgoliaParam(
          data['universityName'],
          ParamType.String,
          false,
        ),
        branchName: convertAlgoliaParam(
          data['branchName'],
          ParamType.String,
          false,
        ),
