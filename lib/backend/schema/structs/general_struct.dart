...
class GeneralStruct extends FFFirebaseStruct {
  ...
  static GeneralStruct fromAlgoliaData(Map<String, dynamic> data) =>
      GeneralStruct(
        ...
        gmapLink: convertAlgoliaParam(
          data['gmapLink'],
          ParamType.String,
          false,
        ),
        fbLink: convertAlgoliaParam(
          data['fbLink'],
          ParamType.String,
          false,
        ),
        instaLink: convertAlgoliaParam(
          data['instaLink'],
          ParamType.String,
          false,
        ),
        inLink: convertAlgoliaParam(
          data['inLink'],
          ParamType.String,
          false,
        ),
        ...
        addressManualTranslate: convertAlgoliaParam(
          data['addressManualTranslate'],
          ParamType.DataStruct,
          false,
