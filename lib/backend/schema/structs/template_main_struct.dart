...
class TemplateMainStruct extends FFFirebaseStruct {
  ...
  static TemplateMainStruct fromAlgoliaData(Map<String, dynamic> data) =>
      TemplateMainStruct(
        data: convertAlgoliaParam(
          data['data'],
          ParamType.DataStruct,
          false,
          structBuilder: TemplateMessagePartStruct.fromAlgoliaData,
        ),
        ...
        templateRef: convertAlgoliaParam(
          data['templateRef'],
          ParamType.DocumentReference,
          false,
        ),
